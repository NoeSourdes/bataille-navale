...
export const Features = () => {
  ...
  return (
    <div className="relative mt-20">
      <div className="absolute -rotate-12 w-[400px] h-96 top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 rounded-full bg-gradient-to-r from-blue-500 to-blue-800 z-10 blur-[300px]"></div>
